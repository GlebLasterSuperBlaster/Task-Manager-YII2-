 ...
 *
 * @property User $ActivedTasks
 * @property User $CreatedTasks
 * @property User $UpdatedTasks
 * @property User $CreatedProjects
 * @property User $UpdatedProjects
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    const STATUSE_LABELS = [
        ...
        self::STATUS_INACTIVE => 'пользователь неактивен',
    ...
    public function getActivedTasks(){
        return $this->hasOne(Task::className(), ['executor_id' => 'id']);
    }

    public function getCreatedTasks(){
        return $this->hasOne(Task::className(), ['creator_id' => 'id']);
    }

    public function getUpdatedTasks(){
        return $this->hasOne(Task::className(), ['updater_id' => 'id']);
    }

    public function getCreatedProjects(){
        return $this->hasOne(Project::className(), ['creator_id' => 'id']);
    }

    public function getUpdatedProjects(){
        return $this->hasOne(Project::className(), ['updater_id' => 'id']);
    }
